...
public class Leraar {
	...
	public void print() {
		System.out.println("Leraar " + this.naam + " " + this.voornaam + " is aangesteld voor " + this.aanstellingsPerc + "%");
		...
		for (int i = 0; i < vakken.length; i++) {
			if (vakken[i] != null) {
				if (vakken[i].getJaar().equals("1")) {
					uitprintJaar1.append("\t").append(vakken[i].getCode()).append("\t").append(vakken[i].getNaam()).append("\t").append(vakken[i].getAantalSTP()).append("\n");
				} else {
					if (vakken[i].getJaar().equals("2")) {
						uitprintJaar2.append("\t").append(vakken[i].getCode()).append("\t").append(vakken[i].getNaam()).append("\t").append(vakken[i].getAantalSTP()).append("\n");
					} else {
						uitprintJaar3.append("\t").append(vakken[i].getCode()).append("\t").append(vakken[i].getNaam()).append("\t").append(vakken[i].getAantalSTP()).append("\n");
					}
				}
			}
		}
