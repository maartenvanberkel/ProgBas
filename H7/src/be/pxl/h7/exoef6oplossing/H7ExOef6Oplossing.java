package be.pxl.h7.exoef6oplossing;

public class H7ExOef6Oplossing {
	...
	public static void main(String[] args) {
		...
		String tekst = "de strip met het hoogst aantal stemmen is ".concat(hoogsteTitel).concat(" van auteur ")
				.concat(hoogsteAuteur);
